...
{ 
   switch (i)
   {
      ...
      case 8: return 1 - (1 << 8);
      case 9: return 1 - (1 << 9);
      case 10: return 1 - (1 << 10);
      case 11: return 1 - (1 << 11);
      case 12: return 1 - (1 << 12);
      case 13: return 1 - (1 << 13);
      case 14: return 1 - (1 << 14);
      case 15: return 1 - (1 << 15);
      default: return 0;
   }
};
//------------------------------------------------------------------------------
...
static uint8 __attribute__((unused)) findEOI(void)
{
   uint8 c;
   uint8 status;
